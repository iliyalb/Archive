...
// contract is similar to a class in blockchain
contract SpaceDoggos {
    ...
    // mapping is same as hashing a key value pair
    ...
    {
      // Ethereum’s KECCAK-256 algorithm that produces a 256-bit hexadecimal number
