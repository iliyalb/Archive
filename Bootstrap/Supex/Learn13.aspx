<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Learn13.aspx.cs" Inherits="Learn01" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Building responsive components</title>
    <%--
        http://goo.gl/xkQRu
        .visible-sm class show on small devices
        .hidden-sm class will not show up on small devices but show in medium or large devices
    --%>
        ...
        <section class="container">
            ...
            <div class="content row">
                <section class="main col col-lg-8">
                    <%-- Responsive: show one paragraph in small devices. --%>
                    <article class="intro">
                        <h2>Main contents goes here...</h2>
                        <p>My name is Mehrdad Naderi and I am 25 years old.</p>
                        <p class="hidden-sm">
                            My name is Mehrdad Naderi and I am 25 years old. 
                            My name is Mehrdad Naderi and I am 25 years old. 
                            My name is Mehrdad Naderi and I am 25 years old.
                            My name is Mehrdad Naderi and I am 25 years old.
                            My name is Mehrdad Naderi and I am 25 years old.
