<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Learn19.aspx.cs" Inherits="Learn01" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Adding the registeration promo</title>
        ...
        <section class="container">
            ...
            <div class="content row">
                ...
                <section class="sidebar col col-lg-4">
                    <%--aside register--%>
                    <%--I used aside tag because it's a side, instead of article...--%>
