<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Learn27.aspx.cs" Inherits="Learn01" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Bootstrap Less Language</title>
    <%-- LessCss.com --%>
    <%--The less language is a dynamic stylesheet language that  adds a functionality to CSS--%>
    <%-- 
        The first step to dealing with LESS in bootstrap is using variables.less file

        Go to variables.less => add //my colors
        Then go to danger and change the color of danger
    --%>
    <link href="_/css/bootstrap.css" rel="stylesheet" />
    <link href="_/components/less/bootstrap.less" rel="stylesheet" />
</head>
<body id="Home">
                        ...
                        <div class="accordion" id="schedule">
                            ...
                            <div id="monday" class="accordion-body collapse">
                                <section class="accordion-inner">
                                    ...
                                    <p>
                                        <a href="schedule.aspx#monday" class="btn btn-danger btn-small">Monday's schedule
                                        </a>
                                    </p>
                                </section>
                            </div>
                            ...
                            <section class="accordion-group">
                                <div class="accordion-heading">
                                    <a href="#friday" class="accordion-toggle" data-toggle="collapse" data-parent="#schedule">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                        Friday
                                    </a>
                                </div>
                            ...
                            <div id="friday" class="accordion-body collapse">
                                <section class="accordion-inner">
                                    <p>Some text goes here.</p>
                                    <p>
                                        <a href="schedule.aspx#friday" class="btn btn-danger btn-small">Friday's schedule
                                        </a>
                                    </p>
                                </section>
                            </div>
