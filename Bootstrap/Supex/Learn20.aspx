<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Learn20.aspx.cs" Inherits="Learn01" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Using modal photos</title>
    <%--
        Creating modals are about complicated
    --%>
...
<body id="Home">
            ...
            <div class="content row">
                <div class="col-lg-12">
                    <header class="clearfix">
                        ...
                        <%-- (3) Modal => back to javascript --%>
                        <section id="modal" class="modal fade">
                            <%-- Modals can have different classes: body, footer, header, ... --%>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //(2) show modals => go to the header section
            $('.modalphotos img').on('click', function () {
                //modal is a bootstrap function
                $('#modal').modal({
                    show: true,
                })

                //(4) open image in modal format (remove the additional end then add jpg)
