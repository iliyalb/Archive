<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Learn15.aspx.cs" Inherits="Learn01" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Adding a photo grid (1)</title>
            ...
            <div class="content row">
                <section class="main col col-lg-8">
                    <article class="intro">
                        ...
                        <%-- Photo Grid creates like this by just photogrid class --%>
                        <div class="component photogrid clearfix">
                            <a href="default.aspx"><img src="Images/smallsupexlogo.jpg" alt="Supex Logo 1" /></a>
                            <a href="default.aspx"><img src="Images/smallsupexlogo2.jpg" alt="Supex Logo 2" /></a>
                            <a href="default.aspx"><img src="Images/smallsupexlogo3.jpg" alt="Supex Logo 3" /></a>
                            <a href="default.aspx"><img src="Images/smallsupexlogo2.jpg" alt="Supex Logo 2" /></a>
                            <a href="default.aspx"><img src="Images/smallsupexlogo.jpg" alt="Supex Logo 1" /></a>
                            <a href="default.aspx"><img src="Images/smallsupexlogo3.jpg" alt="Supex Logo 3" /></a>
                            <a href="default.aspx"><img src="Images/smallsupexlogo2.jpg" alt="Supex Logo 2" /></a>
