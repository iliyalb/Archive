<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Learn24-source.aspx.cs" Inherits="Learn01" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Activate schedule tabs (Source)</title>
    <%--
        Go to the sidebar => schedule => change days to monday, tuesday, wednesday
        => change anchor hrefs to Learn24-target.aspx#monday , ...
        => Finally, run this page and click on buttons in accordion
    --%>
            ...
            <div class="content row">
                <section class="main col col-lg-8">
                    ...
                    <a class="pull-right" href="default.aspx">
                        <img src="Images/smallsupexlogo.jpg" alt="Photo of supex logo" /></a>
                        ...
                        <div class="accordion" id="schedule">
                            ...
                            <div id="monday" class="accordion-body collapse">
                                <section class="accordion-inner">
                                    ...
                                    <p>
                                        <a href="Learn24-target.aspx#monday" class="btn btn-danger btn-small">Monday's schedule
                                        </a>
                                    </p>
                                </section>
                            </div>
                            ...
                            <section class="accordion-group">
                                <div class="accordion-heading">
                                    <a href="#tuesday" class="accordion-toggle" data-toggle="collapse" data-parent="#schedule">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                        Tuesday
                                    </a>
                                </div>
                            ...
                            <div id="tuesday" class="accordion-body collapse">
                                <section class="accordion-inner">
                                    <p>Some text goes here.</p>
                                    <p>
                                        <a href="Learn24-target.aspx#tuesday" class="btn btn-danger btn-small">Tuesday's schedule
                                        </a>
                                    </p>
                                </section>
                            </div>
                            ...
                            <section class="accordion-group">
                                <div class="accordion-heading">
                                    <a href="#wednesday" class="accordion-toggle" data-toggle="collapse" data-parent="#schedule">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                        Wednesday
                                    </a>
                                </div>
                            ...
                            <div id="wednesday" class="accordion-body collapse">
                                <section class="accordion-inner">
                                    <p>Some text goes here.</p>
                                    <p>
                                        <a href="Learn24-target.aspx#wednesday" class="btn btn-danger btn-small">Friday's schedule
                                        </a>
                                    </p>
                                </section>
                            </div>
